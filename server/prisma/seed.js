// Seeds the database with the original mock data (client/src/api/mockDb.js),
// hashing the demo passwords. Safe to re-run: it clears tables first.
...
async function main() {
  ...
  console.log(`Seeded ${users.length} users, ${exams.length} exams, ${submissions.length} submissions.`)
}
